...
public class MiniGame4DotConnectManager : MonoBehaviour
{
    ...
    private void TryBeginDrag()
    {
        if (_linePrefab == null)
        {
            Debug.LogError("[MiniGame4] LinePrefab�� �������� �ʾҽ��ϴ�.");
            return;
        }
    ...
    private void BuildAnswerEdges()
    {
        ...
        foreach (ConnectionRule rule in _clearRules)
        {
            ...
            {
                Debug.LogWarning("[MiniGame4] �ڱ� �ڽŰ� ����� ���� ��Ģ�� ���õ˴ϴ�.");
                continue;
            }
            ...
            {
                Debug.LogWarning($"[MiniGame4] �ߺ��� ���� ������ �ֽ��ϴ�: {edge}");
            }
        }
    }
    ...
    private void ValidateNodeIds()
    {
        ...
        foreach (MiniGame4DotNode node in _nodes)
        {
            ...
            if (!ids.Add(node.Id))
            {
                Debug.LogError($"[MiniGame4] �ߺ��� DotNode ID�� �ֽ��ϴ�: {node.Id}", node);
            }
        }
    }
